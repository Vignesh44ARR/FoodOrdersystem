...
?><center> <h4 style="color:red; background-color:white;"> <?php echo $mes; ?></style></h4></center><?php
       ...
       <center>
            <div class="col-lg-8 col-sm-12">
                <br><br><br>
                <h1 class="text-center" style="background-color:white;">Customer List</h1>
                <br>
                <!--Export excel button-->
<form action="../csvexport/usersdataexport.php" method="POST">
    ...
    while($row = $result ->fetch_assoc())
    {
       echo '
        <tr class="b">
          ...
          <td>'.$row["door"].",".$row["street"].",".$row["town"].",".$row["pin"].'</td>
		  <td><a  class="btn btn-primary" href="viewuser.php?email='.$row["email"].'">View</a></td>
